...
const displayFindIndexstudentId = (studentId) => {
    const studentIdFind = students.findIndex((student) => student.studentId === studentId);
    return studentIdFind;

};

console.log(displayFindIndexstudentId(103));